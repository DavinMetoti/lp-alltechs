...
const OWNER = {
  ...
  quote:
    "Didalam melaksanakan tugas – tugas yang diberikan oleh klien, PT. ALLTECHS SOLUSINDO telah berpegang teguh pada komitmen untuk memberikan yang terbaik bagi kepercayaan yang telah diterima. Hal ini didasari oleh pertimbangan bahwa PT. ALLTECHS SOLUSINDO ingin lebih dapat menempatkan diri sebagai partner dari sekedar penerima dan pelaksana kerja.",
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-12 items-stretch">
              ...
              <div className="md:col-span-4 relative min-h-[280px] md:min-h-full bg-zinc-100">
                <Image
                  src={OWNER.photo}
                  alt={`${OWNER.name} - Direktur PT. ALLTECHS SOLUSINDO`}
                  fill
          ...
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-14 items-start">
            ...
            <div className="lg:w-64 shrink-0 space-y-3">
              ...
              <p className="text-sm text-zinc-500 leading-relaxed">
                Sertifikasi resmi dan Lisensi Kemitraan Pabrikan yang dimiliki oleh Hartono sebagai Direktur PT. ALLTECHS SOLUSINDO.
              </p>
            </div>
